...
def execution_contract(skill, environ):
    ...
    return (
        ...
        "Stage every mandatory Agent's verbatim result as a run-scoped role-AGENT.json "
        "and write the roles.json receipt last, exactly as run-contract.md specifies: "
        "that hash-bound receipt, not the session transcript, decides completion. "

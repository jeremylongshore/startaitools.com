...
toc = true
tldr = "Before handing a shared, governed system to a team, a structured adversarial review that verifies against live state is what turns 'we shipped the safety work' into the actual list of risks you have — and every durable fix that followed enforced one boundary: the model proposes, the deterministic system owns identity, trust, and durable state."
+++

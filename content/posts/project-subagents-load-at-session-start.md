...
slug = 'project-subagents-load-at-session-start'
date = 2026-09-04T08:00:00-05:00
draft = false
...
tldr = "Eight project-specific subagents were committed to intent-longbox on 2026-09-03 but the session that ran all day 2026-09-04 started before those files existed. Every agent dispatch fell back to spawning general-purpose with the project definition pasted in. The behavior was correct. The label was wrong. A human reading the log at 21:45 noticed."
+++
...
- [Every Verdict Carries the Scope It Actually Ran](/posts/a-green-result-only-covers-what-it-ran/)
- [When a Gate Should Re-Run the Step Instead of Trusting Its Receipt](/posts/stop-trusting-the-stored-claim/)
- [A Path Is Not Proof of Identity](/posts/a-path-is-not-proof-of-identity/)

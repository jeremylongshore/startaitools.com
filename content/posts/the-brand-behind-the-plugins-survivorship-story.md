...
Most founder stories lead with the scoreboard: 2,586 GitHub stars and 49.9K installs on Vercel's skills.sh directory. NPM is a separate channel. The catalog has 454 published packages, and the complete 2026-07-29 registry snapshot recorded 33,555 downloads across all of them over the prior 30 days. For a package-level receipt, `@intentsolutionsio/ccpi` alone recorded 2,084 downloads over the last year as of 2026-07-27. Those are different scopes and windows: 2,084 is not the catalog total. The point is the scoreboard is what someone reads after they have already decided whether to trust you, not before. The thing that earns the trust is the long, boring middle where everything almost died and didn't.
...
The thing nobody says out loud about the OSS playbook is that 2,586 stars is small. Marketplace-class traction is six figures, not four. This is not an aggregator site. I built the catalog and wrote more than 2,000 of its 2,810 skills; a handful of external contributors added the rest. The repository also contains 425 plugins and 200 agents. Vercel's skills.sh directory currently reports 49.9K total installs for this repository. Most AI tooling sits in a distribution valley: too big for a personal project, too small for an enterprise platform. The companies that escape the valley are not the ones with the best code; they are the ones who figure out distribution first.

That is the bind this piece lands alongside. Four people in the funding community self-discovered the work in public. Polygon CTO Mudit Gupta called it out publicly on X and LinkedIn: that is searchable. Nixtla paid us to ship against it. Lit Protocol and Elm both reached out. Anthropic issued the public badge. The Kilo AI inbound is in flight; will update if it becomes a fifth. Five companies whose combined funding exceeds 500 million dollars found the work without outbound. The product worked, the documentation told the right story, the right people found it.

These are two different facts. Anthropic's [Claude Partner Network](https://www.anthropic.com/news/services-track-partner-hub) is a firm-level program for organizations bringing Claude into production. My public [Claude Partner Badge - Claude Code](https://www.credly.com/badges/ddf22fb4-0aa6-46b3-a93b-0b45b509e471) is an individual credential. Our internal count as of August 1, 2026 is more than 50 people studying toward Anthropic certification through Intent Solutions, but studying is not the same as being an active certified practitioner. Anthropic's Select tier requires at least 10 active certified individuals, two joint customers deployed in production in the trailing 12 months, and one public customer story. We have a real training pipeline and a verifiable badge; we do not claim Select-partner status. The work is real. Distribution is still the next constraint.
...
- Plugin marketplace live star + fork count: `https://github.com/jeremylongshore/claude-code-plugins-plus-skills`. As of 2026-08-01 the observed figures are 2,586 stars and 373 forks. The footer on jeremylongshore.com and the .about page on startaitools.com both render the same live count via the GithubRepoStarsCountPlugin, not hand-maintained.
- Distribution receipts: Vercel's `skills.sh` listing (`https://skills.sh/jeremylongshore/claude-code-plugins-plus-skills`) reports 49.9K total installs for this repository. The generated NPM registry snapshot (`https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/main/marketplace/src/data/npm-stats.json`) counted 454 published packages and 33,555 downloads across all packages over the last 30 days as of 2026-07-29. The `@intentsolutionsio/ccpi` package-level receipt is 2,084 downloads in the 365-day window ending 2026-07-26, captured 2026-07-27 (`https://api.npmjs.org/downloads/point/2025-07-27:2026-07-26/@intentsolutionsio%2fccpi`). The scopes and windows are labeled separately.

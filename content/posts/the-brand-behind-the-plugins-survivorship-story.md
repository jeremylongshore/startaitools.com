...
The relevant institutional context is Anthropic's [Claude Partner Network](https://www.anthropic.com/news/services-track-partner-hub), a program for firms helping enterprises put Claude into production. Anthropic's published Select tier requires at least 10 active certified individuals, two joint customers deployed in production, and one public customer story. My credential is an individual public badge; it is not evidence of a seven-person Anthropic cohort. The work is real and the credential is verifiable, but distribution is still the long pole.

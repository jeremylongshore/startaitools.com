...
slug = 'the-version-number-that-only-existed-on-the-client'
...
- [The Ghost in the Catalog](/posts/the-ghost-in-the-catalog/) covers another case where system metadata and runtime reality diverged.
- [The Drills Passed, Reality Did Not](/posts/the-drills-passed-reality-did-not/) covers the day the Buzz relay's wrapped update lane referenced above was first built, and three separate hermetic test drills that passed while the real system failed.
- [Do Not Blindly Restart](/posts/do-not-blindly-restart/) covers the same class of lying label from an earlier week: a notification script that reported success unconditionally, whether or not anything actually sent.

...
slug = 'three-commits-between-the-rule-and-the-violation'
...
[Nothing Read It, So Nothing Failed](/posts/nothing-read-it-so-nothing-failed/) covers the same failure class at Tier 3 and broader scale.

[The Check That Only Confirmed a Name](/posts/the-check-that-only-confirmed-a-name/) and [The Ghost in the Catalog](/posts/the-ghost-in-the-catalog/) are adjacent instances in this family.

...
slug = 'the-grade-fell-and-nothing-regressed'
...
tldr = "A strict service and api test matrix reclassified two absent layers, L5 security scanning and L4 contract testing, from P2 to P0, which dropped the audit grade from A- (90) to B+ (84). Nothing regressed. Line coverage rose from 99.56% to 99.67%, unit tests went from 92 to 118, and integration stayed 14 of 14 against postgres:16. The contract lane the new grade demanded found a real bug on its first run: an oversize photo upload was truncated at 25 MiB and recorded as HTTP 201."
+++
...
- [Barcode first, vision model second](/posts/barcode-first-vision-model-second/)
- [One corrected check, fifteen repos](/posts/one-corrected-check-fifteen-repos/)

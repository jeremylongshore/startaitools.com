...
slug = 'vite-dev-server-in-production-the-871-byte-tell'
...
tldr = "If your production HTML contains /@vite/client, you are not running production — you are shipping your dev server to every visitor, and three independent signals make this detectable in under a minute."
+++

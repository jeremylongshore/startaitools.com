...
slug = 'braves-booth-v1-release-player-drilldown'
...
toc = true
tldr = "v1.0.0 of Braves Booth Intelligence shipped today. The flagship feature: every player name in the app is now clickable, opening a slide-over panel with career stats, tonight's game line, and radio-ready bio nuggets. A lineup cache bug surfaced during live testing — lineups vanished after 5 minutes because the cache TTL expired and the getter returned null instead of re-fetching. Six commits, 27 files changed, 1,684 insertions."
+++

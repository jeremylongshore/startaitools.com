...
slug = "hardening-a-marketplace-in-one-day"
...
tldr = "On 2026-09-08 the marketplace hardened along one shared seam: an Omarchy plugin tree cannot accidentally ship AGENTS.md or CLAUDE.md. The contributing-clanker added a C44 gate that travels with the contributor workflow, omarchy-omatrail-entry applied it, and the same pass pushed a portable install integrity contract into the CLI, a 727-line TS file plus a 156-line JSON schema that names what a portable install must carry. Sixteen omarchy entry repos got the same contributor workflow template on the same day. claude-code-plugins closed four high-severity CodeQL findings, hardened the CodeQL parser, hardened the gitleaks fingerprint verifier, and added nested-function decoy rejection to the identity compatibility checker."
+++
...
- [A green result only covers what it ran](/posts/a-green-result-only-covers-what-it-ran/)
- [The Cost of One Feature in a Sealed Repo](/posts/the-cost-of-one-feature-in-a-sealed-repo/)

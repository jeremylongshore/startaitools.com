...
slug = "a-953-line-skill-entry-fits-the-budget-again"
date = 2026-09-09T10:00:00-06:00
draft = false
...
tldr = "On 2026-09-09 contributing-clanker split skills/contribute/SKILL.md from 953 lines to 267 lines plus four new pull-only references (operations.md, repo-intake.md, submission-policy.md, and a slimmed workflow-guide.md), and seventeen Omarchy entry repos each merged chore(deps) refreshes that bump @intentsolutions/audit-harness from 1.3.1 to 1.4.0, pin jeremylongshore/minimax-code-review to v0.5.0 SHA bcaa65182, drop a vulnerable qs override, and roll the anti-tamper seal. omarchy-mlb-booth-entry shipped its own separate feat: a persistent club and clock settings form. Two batches of hygiene on the same day, neither surprising on its own."
+++
...
- [Hardening a Marketplace in One Day](/posts/hardening-a-marketplace-in-one-day/) (2026-09-08, the previous day's sweep across the same estate)
- [One Corrected Check, Fifteen Repos](/posts/one-corrected-check-fifteen-repos/) (2026-08-30, the multi-repo propagation pattern this day repeated)
- [Enforcement Travels With the Code: Shipping @intentsolutions/audit-harness v0.1.0](/posts/audit-harness-v010-enforcement-travels-with-code/) (2026-04-21, the audit-harness origin)

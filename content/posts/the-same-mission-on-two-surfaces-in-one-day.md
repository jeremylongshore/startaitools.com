...
slug = "the-same-mission-on-two-surfaces-in-one-day"
date = 2026-09-10T10:00:00-06:00
draft = false
...
tldr = "On 2026-09-10 the Beacon Nine mission launched twice in one day across two brand new Omarchy entry repos. omarchy-omaquest-entry shipped a QML/JS bar-widget teaser: Overlay.qml 354 lines, BarWidget.qml 31 lines, Model.js 124 lines, a QML-to-Model contract, a marketplace claim ledger, and a 16-script c28-c44 gate lane. The teaser runs locally in QML and JavaScript without accounts, saves, telemetry, payment flow, or installer; the only outbound action is a user-triggered xdg-open to the fixed parent-facing guide after the mission is complete. omarchy-typing-adventure shipped an Electron + TypeScript desktop app: src/main.ts 518 lines, src/game.ts 98 lines, src/style.css 285 lines, electron/main.cjs 111 lines, a seven-day local trial, Ed25519-signed offline license import, and Linux AppImage packaging. Both repos carry a marketplace claim ledger and a brand voice profile. omarchy-listening-post-entry landed only a beads init."
+++
...
- [Hardening a Marketplace in One Day](/posts/hardening-a-marketplace-in-one-day/) (2026-09-08, the C44 gate that now ships with the teaser)
- [A 953-line skill entry fits the budget again](/posts/a-953-line-skill-entry-fits-the-budget-again/) (2026-09-09, the contributor workflow refactor)
- [The Corrected Record Was Still Wrong](/posts/the-corrected-record-was-still-wrong/) (2026-09-06, the same-day site rebuild lesson that informs the teaser claim ledger)

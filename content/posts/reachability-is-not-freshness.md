...
slug = 'reachability-is-not-freshness'
date = 2026-09-17T10:00:00-06:00
draft = false
...
tldr = "A public mission-control feed returned HTTP 200 for two months while describing a July 11 snapshot. The root defect was the same across six merged fixes: every check that existed was measuring reachability (does the endpoint answer?) instead of freshness (is the answer current?). Reachability and freshness are separate domains and both must be checked."
+++
...
- [The Status Nothing Could Write To](/posts/the-status-nothing-could-write-to/)

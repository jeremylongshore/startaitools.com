...
slug = 'the-second-review-that-audits-the-claims'
...
tldr = "On 2026-09-05 a second adversarial review layer audited written claims against the artifacts those claims cite, across a Postgres and TypeScript security codebase and an unrelated set of contract drafts. It repaired about twenty statements of fact in records that were already being treated as finished, some of them ratified, including a security claim a reviewer measured false and a use of the word proved that the evidence never reached. The first review checks whether the decisions are right. The second checks whether the sentences about those decisions are true."
toc = true
+++

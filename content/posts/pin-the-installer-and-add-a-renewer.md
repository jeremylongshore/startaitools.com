...
slug = 'pin-the-installer-and-add-a-renewer'
date = 2026-09-24T08:00:00-05:00
draft = false
...
tldr = 'A CI gate that resolves whatever the registry serves is a random walk. On 2026-09-19 an upstream release turned the main branch red across the Intent Solutions estate with no diff to blame. Pin the installer to a specific version, then add a renewer so the pin is refreshed by review.'
+++
...
- [Fix the Dependabot Pile-Up: Policy Over Patches](/posts/dependabot-pile-up-fix-the-policy/)
- [Transitive CVE Clearance: The Dual-Layer Pattern](/posts/transitive-cve-clearance-dual-layer-pattern/)
- [Software Supply Chain Security After Axios](/posts/software-supply-chain-security/)

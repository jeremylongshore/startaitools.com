...
slug = 'when-live-numbers-argue-back'
date = 2026-08-02T10:00:00-06:00
draft = false
...
- [The Version Number That Only Existed on the Client](/posts/the-version-number-that-only-existed-on-the-client/) is the preceding day, same theme: a system telling the truth about its own live state instead of a label.
- [The Ghost in the Catalog](/posts/the-ghost-in-the-catalog/) covers the same class of failure from the other direction: a claim that looked live but was not.

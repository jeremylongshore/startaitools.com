...
**Goal:** Get all Python libraries ready for IAMS platform
...
- `IAMS-LEARNING-JOURNAL.md` - Learning notes
- `IAMS-SITE-MAP-BLUEPRINT.md` - Site structure
...
### Hugo Site
- `content/iams/_index.md` - Site home
- `content/iams/journal/2025-10-29.md` - This entry!
...
### Our Code
- IAMS Repository: `/home/jeremy/000-projects/iams/`
